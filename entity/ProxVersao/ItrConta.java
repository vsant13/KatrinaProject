 ...
 */
@Entity
@Table(name = "ITR_CONTA")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ItrConta.findAll", query = "SELECT i FROM ItrConta i"),
    @NamedQuery(name = "ItrConta.findByIdConta", query = "SELECT i FROM ItrConta i WHERE i.idConta = :idConta"),
    @NamedQuery(name = "ItrConta.findByFkEmpresa", query = "SELECT i FROM ItrConta i WHERE i.fkEmpresa = :fkEmpresa"),
    @NamedQuery(name = "ItrConta.findByNumeroConta", query = "SELECT i FROM ItrConta i WHERE i.numeroConta = :numeroConta"),
    @NamedQuery(name = "ItrConta.findByDescricaoConta", query = "SELECT i FROM ItrConta i WHERE i.descricaoConta = :descricaoConta"),
    @NamedQuery(name = "ItrConta.findByValorConta1", query = "SELECT i FROM ItrConta i WHERE i.valorConta1 = :valorConta1"),
    @NamedQuery(name = "ItrConta.findByValorConta2", query = "SELECT i FROM ItrConta i WHERE i.valorConta2 = :valorConta2"),
    @NamedQuery(name = "ItrConta.findByValorConta3", query = "SELECT i FROM ItrConta i WHERE i.valorConta3 = :valorConta3"),
    @NamedQuery(name = "ItrConta.findByValorConta4", query = "SELECT i FROM ItrConta i WHERE i.valorConta4 = :valorConta4"),
    @NamedQuery(name = "ItrConta.findByValorConta5", query = "SELECT i FROM ItrConta i WHERE i.valorConta5 = :valorConta5"),
    @NamedQuery(name = "ItrConta.findByValorConta6", query = "SELECT i FROM ItrConta i WHERE i.valorConta6 = :valorConta6"),
    @NamedQuery(name = "ItrConta.findByValorConta7", query = "SELECT i FROM ItrConta i WHERE i.valorConta7 = :valorConta7"),
    @NamedQuery(name = "ItrConta.findByValorConta8", query = "SELECT i FROM ItrConta i WHERE i.valorConta8 = :valorConta8"),
    @NamedQuery(name = "ItrConta.findByValorConta9", query = "SELECT i FROM ItrConta i WHERE i.valorConta9 = :valorConta9"),
    @NamedQuery(name = "ItrConta.findByValorConta10", query = "SELECT i FROM ItrConta i WHERE i.valorConta10 = :valorConta10"),
    @NamedQuery(name = "ItrConta.findByValorConta11", query = "SELECT i FROM ItrConta i WHERE i.valorConta11 = :valorConta11"),
    @NamedQuery(name = "ItrConta.findByValorConta12", query = "SELECT i FROM ItrConta i WHERE i.valorConta12 = :valorConta12"),
    @NamedQuery(name = "ItrConta.findByVersaoDocumento", query = "SELECT i FROM ItrConta i WHERE i.versaoDocumento = :versaoDocumento"),
    @NamedQuery(name = "ItrConta.findByDataInicioRefereciaPrincipal", query = "SELECT i FROM ItrConta i WHERE i.dataInicioRefereciaPrincipal = :dataInicioRefereciaPrincipal"),
    @NamedQuery(name = "ItrConta.findByDataFimRefereciaPrincipal", query = "SELECT i FROM ItrConta i WHERE i.dataFimRefereciaPrincipal = :dataFimRefereciaPrincipal")})
public class ItrConta implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ItrConta)) {
            return false;
        }
        ItrConta other = (ItrConta) object;
    ...
    public String toString() {
        return "entity.ItrConta[ idConta=" + idConta + " ]";
    }
